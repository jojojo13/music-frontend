...
export class SongsServiceService {
  ...
  getSongs(){
    return this.http.get<Song[]>("http://localhost:3000/songs",{headers:this.header});
  }
  getAllsong(){
    return this.http.get<Song[]>("http://localhost:3000/allsongs",{headers:this.header});
  ...
  getTopViewsSong(){
    return this.http.get<Song[]>("http://localhost:3000/chart",{headers:this.header});
  }
